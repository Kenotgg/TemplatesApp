...
export const Header: React.FC<HeaderProps> = ({ user }) => {
    return (
        <>
            {user ? (
                <Box bgGradient='linear(to-r, blue.400, blue.500)' margin={0} height={50} top={0} position={'sticky'} zIndex={1000} color={'white'}>
                    <Stack display={'flex'} alignItems={'center'} justifyContent={'space-between'} direction={'row'}>
                        ...
                        <Text fontWeight={'bold'} fontSize={21}>TemplatesApp</Text>
